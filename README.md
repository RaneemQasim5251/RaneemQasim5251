...
### **🏆 Key Achievements**
- **🌟 World Champion**: 1st place out of 495 participants in Space Debris Detection Challenge
- **🤖 AI Innovation**: Developed Arabic Metro AI Assistant (Siraj) for Riyadh Metro
- **💓 Research**: Achieved 94% accuracy in rPPG heartbeat detection using computer vision
- **🇸🇦 Impact**: Contributing to Saudi Vision 2030 through AI and space technology

### **🛠️ Tech Stack**
`Python` `TensorFlow` `PyTorch` `OpenCV` `Computer Vision` `Machine Learning` `Deep Learning` `Azure` `Docker` `Space Technology`
